...
class TestDayPlanCardPicker(TestCase):
    ...
    def test_drawing_front_side_id_from_day_plan__return_flip_card(self):
        ...
        self._assert_repository_called_with_side_id_from_day_plan(day_plan, repository)
    ...
    def test_drawing_back_side_id_from_day_plan__return_flip_card(self):
        ...
        self._assert_flip_cards_back_side_was_marked_as_drawn(flip_card)
        self._assert_repository_called_with_side_id_from_day_plan(day_plan, repository)

    def _assert_flip_cards_back_side_was_marked_as_drawn(self, flip_card):
    ...
    def _assert_repository_called_with_side_id_from_day_plan(self, day_plan, repository):
