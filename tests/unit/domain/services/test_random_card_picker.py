...
from tests.unit.domain.entities.test_doubles.day_plan_stub import DayPlanStub, DayPlanFrontSidesStub, \
...
class TestRandomCardPicker(TestCase):
    ...
    def test_drawing_front_side_id_from_day_plan__return_flip_card(self):
        ...
        self._assert_repository_called_with_side_id(day_plan, repository)
    ...
    def _assert_repository_called_with_side_id(self, day_plan, repository):
