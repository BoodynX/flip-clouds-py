...
from tests.unit.domain.vos.test_doubles.flip_card_side_id_stubs import FlipCardSideId_StubFront, FlipCardSideId_StubBack


class TestBox(TestCase):
    def test_adding_ids_to_box_sets__ids_in_sets(self):
        box = Box(PrimarySet(set()), SecondarySet(set()))
        side_id_front = FlipCardSideId_StubFront()
        side_id_back = FlipCardSideId_StubBack()
